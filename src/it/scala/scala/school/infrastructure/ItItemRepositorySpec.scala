package scala.school.infrastructure
...
import scala.school.ITSpec
import scala.school.domain.{ ItemRepository, _ }
import scala.school.infrastructure.flyway.{ FlywayProvider, MigrateResult }
